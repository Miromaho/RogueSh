   ...
   public class Equipment : IEquipment, ITreasure, IDrawable
   {
      ...
      public bool PickUp( IActor actor )
      {
         if ( this is HeadEquipment )
         {
            ...
            RogueGame.MessLogs.AddLine( $"{actor.Name} picked up a {Name} helmet" );
            return true;
         }
         ...
         if ( this is BodyEquipment )
         {
            ...
            RogueGame.MessLogs.AddLine( $"{actor.Name} picked up {Name} body armor" );
            return true;
         }
         ...
         if ( this is HandEquipment )
         {
            ...
            RogueGame.MessLogs.AddLine( $"{actor.Name} picked up a {Name}" );
            return true;
         }
         ...
         if ( this is FeetEquipment )
         {
            ...
            RogueGame.MessLogs.AddLine( $"{actor.Name} picked up {Name} boots" );
            return true;
         }
